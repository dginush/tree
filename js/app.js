const App = (() => {
  ...
  async function saveMember(e) {
    ...
    var d = {
      ...
      photo: photo,
      spouseId: extraVisible
        ? document.getElementById("spouseId")?.value || null
        : existingMember?.spouseId || null,
      status: extraVisible
        ? document.getElementById("status")?.value || "alive"
        : existingMember?.status || "alive",
      deathDate: extraVisible
        ? deathDateVal || null
        : existingMember?.deathDate || null,
      deathBeforeSunset: deathBeforeSunset,
      hebrewDeathDate: extraVisible
        ? hebrewDeathDate
        : existingMember?.hebrewDeathDate || "",
      birthPlace: extraVisible
        ? document.getElementById("birthPlace")?.value?.trim() || ""
        : existingMember?.birthPlace || "",
      phone: extraVisible
      ...
      address: extraVisible
        ? document.getElementById("address")?.value?.trim() || ""
        : existingMember?.address || "",
      occupation: extraVisible
