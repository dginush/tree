const App = (() => {
    ...
    // ============================================
    // תיקון בעיה 1: הסרת טעינת דמו אוטומטית
    // ============================================
    async function initAfterLogin() {
        ...
        // ❌ הוסר! לא טוענים יותר נתוני דוגמה
    ...
    function renderDashboard() {
        ...
        if (!rec.length) rmEl.innerHTML = '<div class="empty-state"><div class="icon">👥</div><h3>ריק</h3><p>הוסיפו את בן המשפחה הראשון!</p><button class="btn btn-primary btn-sm" onclick="App.openAddModal()">➕ הוספה</button></div>';
    ...
    // ============================================
    // ❌ פונקציית loadDemo הוסרה לחלוטין!
    // אין יותר נתוני דוגמה של "משפחת כהן"
    // ============================================
